        ...
        {products.map((product) => (
          <View key={product.id} style={styles.card}>
            <TouchableOpacity onPress={() => openModal(product)}>
              ...
              <Text style={styles.atributosProduto}>
                {product.descricao}
              </Text>
            </TouchableOpacity>
          </View>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <Text style={styles.categoriaCard}>{selectedProduct?.categoria}</Text>
              <Text style={styles.atributosCard}>{selectedProduct?.descricao}</Text>
